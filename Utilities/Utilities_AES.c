/**                                                                             
 *  @file Utilities_AES.c                                                   
 *                                                                              
 *  @date 2021年02月22日 10:13:37 星期一
 *
 *  @author aron566
 *
...
static void ccm_prepare_first_ctr_blk(BYTE counter[], const BYTE nonce[], int nonce_len, int payload_len_store_size);
static void ccm_prepare_first_format_blk(BYTE buf[], int assoc_len, int payload_len, int payload_len_store_size, int mac_len, const BYTE nonce[], int nonce_len);
static void ccm_format_assoc_data(BYTE buf[], int *end_of_buf, const BYTE assoc[], int assoc_len);
static void ccm_format_payload_data(BYTE buf[], int *end_of_buf, const BYTE payload[], int payload_len);
...
/**
  ******************************************************************
  * @brief   Creates the first counter block. First byte is flags, then the nonce, then the incremented part.
  * @param   [in]counter
  * @param   [in]nonce
  * @param   [in]nonce_len
  * @param   [in]payload_len_store_size
  * @return  None.
  * @author  aron566
  * @version V1.0
  * @date    2021-02-22
...
/**
 * @brief ccm_prepare_first_format_blk
 * 
 * @param buf 
 * @param assoc_len 
 * @param payload_len 
 * @param payload_len_store_size 
 * @param mac_len 
 * @param nonce 
 * @param nonce_len 
 */
...
/**
 * @brief XORs the in and out buffers, storing the result in out. Length is in bytes.
 * 
 * @param in 
 * @param out 
 * @param len 
